const PageContactService = require('../services/page-contact.services')
const ResponseHandle = require('../utils/responseHandle')

class PageContactController {
  static async getDetail(req, res) {
    try {
      const result = await PageContactService.getDetail()
  ...
  static async updateDetail(req, res) {
    try {
      ...
      const result = await PageContactService.updateDetail(id, updatedData)
...
module.exports = PageContactController
