...
const publicStorageRoutes = require('./publicStorage.routes')
const userAvatarRoutes = require('./userAvatar.routes')
const pageStorageRoutes = require('./pageStorage.routes')
const blogStorageRoutes = require('./blogStorage.routes')
router.use('/public', publicStorageRoutes)
router.use('/user', userAvatarRoutes)
router.use('/page', pageStorageRoutes)
router.use('/blog', blogStorageRoutes)
